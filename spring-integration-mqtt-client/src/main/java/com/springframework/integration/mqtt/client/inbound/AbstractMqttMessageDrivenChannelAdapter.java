...
public abstract class AbstractMqttMessageDrivenChannelAdapter<T extends MqttClient, B>
	...
	protected @Nullable MqttClientManager<T> mqttClientManager;
	...
	protected AbstractMqttMessageDrivenChannelAdapter(B mqttClientBuilder, String topic) {
		this.mqttClientBuilder = mqttClientBuilder;
		this.topic = topic;
	}

	protected AbstractMqttMessageDrivenChannelAdapter(MqttClientManager<T> mqttClientManager, String topic) {
