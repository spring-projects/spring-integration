...
public class DebeziumMessageProducerSpec
	 ...
	 * {@link ChangeEvent}s as a payload in a single downstream {@link Message}. Such a batch payload is not
	 * serializable. By default, the batch mode is disabled, e.g. every input {@link ChangeEvent} is converted into a
