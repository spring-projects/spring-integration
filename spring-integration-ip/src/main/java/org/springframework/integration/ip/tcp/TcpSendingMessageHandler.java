...
public class TcpSendingMessageHandler extends AbstractMessageHandler implements
	...
	protected TcpConnection obtainConnection(Message<?> message) {
		...
		try {
			...
			logger.error(ex, "Error creating connection " + ((clientConnectionFactory.getComponentName() == null) ? "null" : clientConnectionFactory.getComponentName() + ":" + clientConnectionFactory.getPort()) +
					" serverConnectionFactory " +
					((serverConnectionFactory.getComponentName() == null) ? "null" : serverConnectionFactory.getComponentName() + ":" + serverConnectionFactory.getPort()));
