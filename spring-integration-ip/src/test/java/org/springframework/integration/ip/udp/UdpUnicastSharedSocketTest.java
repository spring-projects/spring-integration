 ...
 * Channel Adapter uses Inbound Channel Adapter shared datagram socket to send outgoing
 * communication instead of creating own separate datagram socket.
 *
 * @author Marcin Pilaczynski
 * @since 4.3
 */
public class UdpUnicastSharedSocketTest implements Runnable {
	...
	public static void main(String[] args) throws Exception {
		new UdpUnicastSharedSocketTest().runIt();
	}
	...
	public void run() {
		...
		AbstractApplicationContext ctx = new ClassPathXmlApplicationContext(
				"common-socket-context.xml",
				UdpUnicastSharedSocketTest.class);
