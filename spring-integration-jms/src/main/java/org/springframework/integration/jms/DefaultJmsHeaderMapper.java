...
public class DefaultJmsHeaderMapper implements JmsHeaderMapper {
	...
	private final boolean mapInboundPriority;

	public DefaultJmsHeaderMapper() {
		this.mapInboundPriority = true;
	}

	/**
	 * Suppress the mapping of inbound priority by using this constructor with 'false'.
	 *
	 * @param mapInboundPriority 'false' to suppress mapping the inbound priority.
	 */
	public DefaultJmsHeaderMapper(boolean mapInboundPriority) {
