...
* Please follow the "Commit Guidelines" described in this chapter of Pro Git: [https://git-scm.com/book/en/Distributed-Git-Contributing-to-a-Project](https://git-scm.com/book/en/Distributed-Git-Contributing-to-a-Project)
...
(Again, for more detail see the Pro Git section on rebasing: [https://git-scm.com/book/en/Git-Branching-Rebasing](https://git-scm.com/book/en/Git-Branching-Rebasing))
