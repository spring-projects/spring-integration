...
/**
 * {@link ScriptVariableGenerator} implementation, which is used by script processors.
 * The result of {@link #generateScriptVariables} is a {@link Map} of provided {@code variables}
 * and {@code payload} and {@code headers} values from {@code Message} parameter.
 *
