...
public class InboundChannelAdapterParserTests {
	...
	public void testWithLocalFiles() throws Exception{
		...
		assertTrue(TestUtils.getPropertyValue(source, "fileSource.scanner.filter.fileFilters", Collection.class)
	...
	public void testLocalFilesAreFound() throws Exception{
		...
		new ClassPathXmlApplicationContext("InboundChannelAdapterParserTests-context.xml", this.getClass()).close();
		assertTrue(new File("target").exists());
	}
