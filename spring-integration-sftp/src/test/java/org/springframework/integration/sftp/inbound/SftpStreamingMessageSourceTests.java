...
public class SftpStreamingMessageSourceTests extends SftpTestSupport {
	...
	@Test
	public void testMaxFetchWithPersistentAcceptOnceFileListFilter() throws Exception {
		SftpStreamingMessageSource messageSource = buildSource();
		var chainFileListFilter = new ChainFileListFilter<DirEntry>();
		final var sftpSystemMarkerFilePresentFileListFilter =
			new SftpSystemMarkerFilePresentFileListFilter(new SftpSimplePatternFileListFilter("*"), ".trg");
		var sftpPersistentAcceptOnceFileListFilter = new SftpPersistentAcceptOnceFileListFilter(
