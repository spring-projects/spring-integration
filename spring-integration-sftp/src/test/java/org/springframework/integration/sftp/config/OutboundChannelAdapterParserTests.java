...
public class OutboundChannelAdapterParserTests {
	...
	public void testOutboundChannelAdapterWithId() {
		...
		assertEquals("#root + '.bar'", TestUtils.getPropertyValue(handler,
				"remoteFileTemplate.temporaryFileNameHelper.temporaryFileNameExpression.expression", String.class));
