...
/**
 * Sftp {@link SessionFactoryResolver}; Used to resolve sessionfactory from message sent
 ...
 *
 */
public class SftpSessionFactoryResolver<F> implements SessionFactoryResolver<F>, IntegrationEvaluationContextAware{
	...
	public SessionFactory<F> resolve(Message<?> message) {
		...
		sessionFactory.setUser(evaluationContext != null ? this.userNameExpression.getValue(evaluationContext, message, String.class)
