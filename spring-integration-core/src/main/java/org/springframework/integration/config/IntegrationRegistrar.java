	...
	static {
		if (ClassUtils.isPresent("org.springframework.integration.dsl.support.Function",
			...
			throw new ApplicationContextException("Starting with Spring Integration 5.0, " +
					"the extra 'spring-integration-java-dsl' is not needed any more: the Java DSL has been merged " +
					"to the core project. Presenting it in the classpath causes class loading conflicts.");
		}
	}
