...
abstract class AbstractStandardMessageHandlerFactoryBean extends AbstractSimpleMessageHandlerFactoryBean<MessageHandler>{
	...
	/**
	 * Subclasses may implement this method to create the MessageHandler.
	 */
	 ...
	 * Subclasses must implement this method to create the MessageHandler.
	 */
	abstract <T> MessageHandler createMessageProcessingHandler(MessageProcessor<T> processor);
