...
public class PointToPointChannelParser extends AbstractChannelParser {
	...
	protected BeanDefinitionBuilder buildBeanDefinition(Element element, ParserContext parserContext) {
		...
		String finalSubscriberChannel = element.getAttribute("final");
		boolean isFinal = "true".equals(finalSubscriberChannel.trim().toLowerCase());
		...
		if (dispatcherElement == null) {
			...
			builder = BeanDefinitionBuilder.genericBeanDefinition(isFinal ? BasicSingleFinalSubscriberChannel.class
					: DirectChannel.class);
		}
		else {
			if (isFinal) {
