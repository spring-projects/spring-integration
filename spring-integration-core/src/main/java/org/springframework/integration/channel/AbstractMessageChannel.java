...
public abstract class AbstractMessageChannel extends IntegrationObjectSupport
	...
	@Override
	public void reset() {
		channelMetrics.reset();
	}

	@Override
	public int getSendCount() {
		return channelMetrics.getSendCount();
	}
	...
	public int getSendErrorCount() {
		return channelMetrics.getSendErrorCount();
	}
	...
	public double getTimeSinceLastSend() {
		return channelMetrics.getTimeSinceLastSend();
	}

	@Override
	public double getMeanSendRate() {
		return channelMetrics.getMeanSendRate();
	}

	@Override
	public double getMeanErrorRate() {
		return channelMetrics.getMeanErrorRate();
	}

	@Override
	public double getMeanErrorRatio() {
		return channelMetrics.getMeanErrorRatio();
	}

	@Override
	public double getMeanSendDuration() {
		return channelMetrics.getMeanSendDuration();
	}

	@Override
	public double getMinSendDuration() {
		return channelMetrics.getMinSendDuration();
	}

	@Override
	public double getMaxSendDuration() {
		return channelMetrics.getMaxSendDuration();
	}

	@Override
	public double getStandardDeviationSendDuration() {
		return channelMetrics.getStandardDeviationSendDuration();
	}

	@Override
	public Statistics getSendDuration() {
		return channelMetrics.getSendDuration();
	}
