...
public interface LockRegistry<L extends Lock> {
	 ...
	 * @since 6.2
	 */
	default <T extends @Nullable Object, E extends Throwable> T executeLocked(Object lockKey,
	 ...
	 * @since 6.2
	 */
	default <T extends @Nullable Object, E extends Throwable> T executeLocked(Object lockKey, Duration waitLockDuration,
