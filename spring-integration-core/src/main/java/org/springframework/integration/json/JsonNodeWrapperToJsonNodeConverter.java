 ...
 * {@link JsonNode}, when the {@link JsonPropertyAccessor.JsonNodeWrapper} can be a result of the expression for JSON in
 * case of the {@link JsonPropertyAccessor} usage.
 *
 * @since 5.4
 */
