 ...
 * Such a bean must be of 'prototype' scope otherwise {@link MessageTransformationException} will be thrown.
...
public class MapToObjectTransformer extends AbstractPayloadTransformer<Map<?, ?>, Object> {
	...
	private final @Nullable String targetBeanName;
	...
	protected void onInit() {
		if (StringUtils.hasText(this.targetBeanName)) {
			Assert.isTrue(getBeanFactory().isPrototype(this.targetBeanName),
	...
	protected Object transformPayload(Map<?, ?> payload) {
		Object target =
				this.targetClass != null
						...
						: getBeanFactory().getBean(this.targetBeanName);
