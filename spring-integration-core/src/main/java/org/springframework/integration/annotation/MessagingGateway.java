 ...
 * to hide the messaging API. The target application’s business logic may be completely unaware
 * of the Spring Integration API, the code interacts instead with a simple interface, only.
 *
 * @author Artem Bilan
 * @since 4.0
 */
