...
public abstract class AbstractBaseMessageHandler extends IntegrationObjectSupport
	...
	protected volatile boolean shouldTrack = false;

	protected volatile AbstractMessageHandlerMetrics handlerMetrics = new DefaultMessageHandlerMetrics();

	protected volatile boolean countsEnabled;

	protected volatile boolean loggingEnabled = true;

	protected MetricsCaptor metricsCaptor;
