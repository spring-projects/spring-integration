...
public class ExpressionEvaluatingMessageListProcessor extends AbstractExpressionEvaluator
	 ...
	 * @param expression a SpEL expression to evaluation during {@link #process(Collection)}.
	 ...
	 * @param expression an expression to evaluation during {@link #process(Collection)}.
	 * @param expectedType an expected result type.
	 * @since 5.0
	 */
