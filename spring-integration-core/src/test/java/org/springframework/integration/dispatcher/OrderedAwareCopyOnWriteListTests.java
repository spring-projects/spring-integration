...
public class OrderedAwareCopyOnWriteListTests {
	...
	public void testAddUnordered(){
		OrderedAwareCopyOnWriteArrayList setToTest = new OrderedAwareCopyOnWriteArrayList();
		setToTest.add("foo");
		setToTest.add("bar");
		setToTest.add("baz");
	...
	public void testAddAllOrderedUnordered(){
		...
		OrderedAwareCopyOnWriteArrayList orderAwareSet = new OrderedAwareCopyOnWriteArrayList();
	...
	private void doConcurrent(){
		final OrderedAwareCopyOnWriteArrayList setToTest = new OrderedAwareCopyOnWriteArrayList();
	...
	public void doConcurrentAll(){
		...
		tempList.add(o9);
		tempList.add(o10);
		final OrderedAwareCopyOnWriteArrayList orderAwareSet = new OrderedAwareCopyOnWriteArrayList();
		Thread t1 = new Thread(new Runnable() {
			public void run() {
				orderAwareSet.addAll(tempList);
	...
	@SuppressWarnings("rawtypes")
	@Test
	public void showPerformanceWhileAddingElement(){

		OrderedAwareCopyOnWriteArrayList list = new OrderedAwareCopyOnWriteArrayList();
		OrderedAwareLinkedHashSet set = new OrderedAwareLinkedHashSet();
		...
		listStopWatch.stop();
		System.out.println("(add)With OrderedAwareCopyOnWriteArrayList: " + listStopWatch.getTotalTimeMillis());

		StopWatch setStopWatch = new StopWatch();
		setStopWatch.start();
		for (int i = 0; i < 10000; i++) {
			set.add("element" + i);
		}
		setStopWatch.stop();
		System.out.println("(add)With OrderedAwareLinkedHashSet: " + setStopWatch.getTotalTimeMillis());
	}

	@SuppressWarnings("rawtypes")
	@Test
	public void showPerformanceWhileIteratingThroughElements(){
