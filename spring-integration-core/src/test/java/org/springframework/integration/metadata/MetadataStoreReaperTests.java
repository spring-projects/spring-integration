...
@ContextConfiguration(classes = MetadataStoreReaperTests.MetadataStoreReaperConfig.class)
public class MetadataStoreReaperTests {
	...
	private void verifyMetadataStore(Phaser phaser, MetadataStore metadataStore) {
		...
		assertThat(metadataStore.keySet()).containsExactlyInAnyOrder("key0", "key1", "key2", "key3", "key4", "key5");
