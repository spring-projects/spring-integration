 ...
 * @since 3.0
 */
@ActiveProfiles("scannerFirst")
@RunWith(SpringJUnit4ClassRunner.class)
public class IntegrationConfigurationWithScannerFirstTests extends AbstractIntegrationConfigurationTests {
	...
	public void testInt2500ConfigurationCreatedOnlyOnceNewCtx() {
		super.testInt2500ConfigurationCreatedOnlyOnceNewCtx("scannerFirst");
	}
