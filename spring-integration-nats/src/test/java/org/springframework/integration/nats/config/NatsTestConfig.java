...
public class NatsTestConfig {
  ...
  public NatsConnectionProperties natsEncryptedConnectionProperties(
      @NonNull @Value("${org.springframework.integration.nats.keyStorePath}")
          final Resource keyStoreLocation,
      @NonNull @Value("${org.springframework.integration.nats.keyStorePassword:}")
          final String keyStorePassword,
      @NonNull @Value("${org.springframework.integration.nats.trustStorePath}")
          final Resource trustStoreLocation,
      @NonNull @Value("${org.springframework.integration.nats.trustStorePassword}")
  ...
  public Connection natsConnection(
      ...
      @NonNull @Value("${org.springframework.integration.nats.credentials}")
          final Resource natsCredentials)
