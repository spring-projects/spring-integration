...
@Repository
public class Stub1ContextConfig extends GeneralContextConfig {

  @Bean
  public static MessageConverter<TestDTOStubV1> messageConvertorOfDTOStub() {
    return new MessageConverter<>(TestDTOStubV1.class);
  }
