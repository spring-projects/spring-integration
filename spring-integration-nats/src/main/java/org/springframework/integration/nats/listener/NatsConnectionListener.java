...
/**
 * Default NATS connection listener.
 *
...
public class NatsConnectionListener implements ConnectionListener {
	...
	private static final Log LOG = LogFactory.getLog(NatsConnectionListener.class);

	@Override
	public void connectionEvent(Connection conn, Events type) {
		LOG.info(
				conn.getOptions().getConnectionName() + " - " + "NATS connection status changed " + type);
	}
}
