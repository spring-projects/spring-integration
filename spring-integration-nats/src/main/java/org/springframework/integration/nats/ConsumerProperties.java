...
public class ConsumerProperties {
  ...
  @NonNull private static final Duration DEFAULT_CONSUMER_MAX_WAIT = Duration.ofSeconds(30);

  @NonNull private String stream;

  @NonNull private String subject;

  @NonNull private String consumerName;

  @NonNull private String queueGroup;

  private int pullBatchSize = DEFAULT_PULL_BATCH_SIZE;

  @NonNull private Duration consumerMaxWait = DEFAULT_CONSUMER_MAX_WAIT;
