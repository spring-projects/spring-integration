...
In many cases, the element names match those of the https://www.enterpriseintegrationpatterns.com/[Enterprise Integration Patterns].
...
By default Spring Integration relies on an instance of `ThreadPoolTaskScheduler` as described in the https://docs.spring.io/spring/docs/current/spring-framework-reference/html/scheduling.html[Task Execution and Scheduling] section of the Spring Framework reference manual.
...
https://docs.spring.io/spring/docs/current/spring-framework-reference/html/scheduling.html#scheduling-task-scheduler-implementations[here],
...
This is an example of https://www.enterpriseintegrationpatterns.com/ReturnAddress.html[Return Address].
