...
The `IntegrationFlowBuilder` infrastructure provides common https://www.enterpriseintegrationpatterns.com/[EIP] for message based applications, such as channels, endpoints, pollers and channel interceptors.
