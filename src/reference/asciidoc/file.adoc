...
In this case all filters and lockers attributes are prohibited on the ``FileReadingMessageSource`` in favor of
their options on the custom `DirectoryScanner`.
