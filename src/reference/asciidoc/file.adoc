...
Version 5.1 introduced the `RecursiveFileListFilter` which recursively runs through the directory and passes all found non-directory files to a delegate `FileListFilter`.
