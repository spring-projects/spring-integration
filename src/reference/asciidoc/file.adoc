...
public class FileReadingJavaApplication {
    ...
    @Bean
    @InboundChannelAdapter(value = "fileInputChannel", poller = @Poller(fixed-rate = "5000"))
...
public class FileReadingJavaApplication {
    ...
    public IntegrationFlow fileReadingFlow() {
         return IntegrationFlows
                  .from(s -> s.file(new File(INBOUND_PATH)).patternFilter("*.txt"),
...
public class FileWritingJavaApplication {
    ...
    public static void main(String[] args) {
        ConfigurableApplicationContext context =
             ...
             gateway.writeToFile("foo.txt", "foo");
    }

    @Bean
    @ServiceActivator(inputChannel = "writeToFileChannel")
    public MessageHandler fileWritingMessageHandler() {
         FileWritingMessageHandler handler = new FileWritingMessageHandler("/usr/integration/files");
...
public class FileWritingJavaApplication {
    ...
    public static void main(String[] args) {
        ...
        fileWritingInput.send(new GenericMessage<>("bar"));
    }
