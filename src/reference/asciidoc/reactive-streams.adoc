...
public class MainFlow {
  @Autowired
  private CustomReactiveSourceMessageSource customReactiveSourceMessageSource;
  
  @Bean
  public IntegrationFlow buildFlow() {
     return IntegrationFlows.from(customReactiveSourceMessageSource)
...
public class MainFlow {  
  @Bean
  public IntegrationFlow buildFlow() {
     return IntegrationFlows.from(new CustomReactiveSourceMessageSource(new CustomReactiveSource()))
...
And now we will be able to use both of the channel adatpers:
```java
public class MainFlow {
  @Autowired
  private CustomReactiveSourceMessageSource customReactiveSourceMessageSource;
