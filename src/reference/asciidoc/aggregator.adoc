...
Starting with version 5.2, a `FluxAggregatorMessageHandler` component has been introduced.
...
By default a `IntegrationMessageHeaderAccessor.CORRELATION_ID` header of the message is consulted.
