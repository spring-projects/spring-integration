...
Starting with version 5.3.1, the inbound channel adapter can be provided with `java.util.function.Supplier<String>` s for the select and update queries, allowing the queries to be altered between polls.
