...
Since_version 5.0, by overloading `MessageGroupPreparedStatementSetter` class you can provide custom implementation to 
 `PreparedStatementSetter` to support different columns or table structure.
