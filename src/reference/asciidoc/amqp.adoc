...
Spring AMQP supports the http://docs.spring.io/spring-amqp/docs/1.6.3.RELEASE/reference/html/_reference.html#delayed-message-exchange[RabbitMQ Delayed Message Exchange Plugin].
...
You can also specify the `delayExpression` property on outbound endpoints (`delay-expression` when using XML configuration).
