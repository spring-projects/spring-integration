...
See the http://docs.spring.io/spring-amqp/docs/1.6.0.RELEASE/reference/html/_reference.html#template-user-id[Spring AMQP documentation] for more information.
