...
The AsyncHttpRequestExecutingMessageHandler implementation is very similar to HttpRequestExecutingMessageHandler instead of delegating to a AsyncRestTemplate. To configure it, write a bean like this:
