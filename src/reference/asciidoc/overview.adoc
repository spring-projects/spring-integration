...
The first two are simple enough to understand, configuration and
...
With that in mind, our config for reading data from an RDBMS table wit JDBC may look like:
