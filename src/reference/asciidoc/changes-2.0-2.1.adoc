...
In Spring Integration 2.0, support for https://groovy.codehaus.org/[Groovy] was added.
...
Spring integration leverages the https://www.springsource.org/spring-gemfire[_Spring Gemfire_] project, providing a thin wrapper over its components.
...
In order to increase community visibility even further, the project was moved from SpringSource hosted Git repositories to https://www.github.com/[Github].
...
In an effort to provide better source code visibility and consequently to monitor the quality of Spring Integration's source code, an instance of https://www.sonarqube.org/[Sonar] was setup and metrics are gathered nightly and made avaiblable at:
