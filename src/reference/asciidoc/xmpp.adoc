...
To switch off the Roster listener for subscriptions you should configure it like `subscription-mode=""`
or as `XmppConnectionFactoryBean.setSubscriptionMode(null)` from Java Configuration.
