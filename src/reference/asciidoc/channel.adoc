...
In the above case the global interceptor will be applied on the 'foo' channel and all other channels that begin with 'bar' or 'input' and 
not to channel starting with 'baz'.
