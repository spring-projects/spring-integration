...
[[x5.1-file-list-filter]]
=== `RecursiveFileListFilter`

Recursively runs through the directory and passes all found non-directory files to a delegate `FileListFilter`.
