...
The `WebSocketHandlerDecoratorFactory` support has been added to the `ServerWebSocketContainer`
to allow "chain"-customization for the internal `WebSocketHandler`.
