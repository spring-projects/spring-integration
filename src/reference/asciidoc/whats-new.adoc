...
[[x5.2-sftp-events]]
==== SFTP Event Publisher

The SFTP module now provides an event listener for certain Apache Mina SFTP server events.
See <<./sftp.adoc#sftp-server-events, Apache Mina SFTP Server Events>> for more information.
