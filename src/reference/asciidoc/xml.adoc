...
For a deeper understanding, see the respective documentation at https://docs.spring.io/spring-ws/docs/current/reference/html/common.html#xpath.
...
Spring's Object/XML Mapping support provides several implementations that support marshalling and unmarshalling by using https://en.wikipedia.org/wiki/Java_Architecture_for_XML_Binding[JAXB], http://www.castor.org/[Castor], http://jibx.sourceforge.net/[JiBX], and others.
