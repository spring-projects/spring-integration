...
You can now benefit from _Conversion Service_ support provided with Spring while configuring many Spring Integration components such as https://www.enterpriseintegrationpatterns.com/DatatypeChannel.html[Datatype Channel].
...
We now provide support for the https://www.enterpriseintegrationpatterns.com/MessageHistory.html[Message History] pattern allowing you to keep track of all traversed components, including the name of each channel and endpoint as well as the timestamp of that traversal.
...
We have provided implementations of the https://www.enterpriseintegrationpatterns.com/ControlBus.html[Control Bus] pattern which allows you to use messaging to manage and monitor endpoints and channels.
...
Also, you can checkout the following blog: https://spring.io/blog/2010/03/29/using-udp-and-tcp-adapters-in-spring-integration-2-0-m3/[TCP/UDP support]
...
To access our repository simply follow this URL: https://git.springsource.org/spring-integration[https://git.springsource.org/spring-integration].
...
Please read this blog to get more info https://spring.io/blog/2010/09/29/new-spring-integration-samples/[New Spring Integration Samples] We have also created many new samples, including samples for every new Adapter.
