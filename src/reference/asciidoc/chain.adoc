...
Similarly, when providing a _Filter_ before some other component in a chain, you are essentially creating a https://www.enterpriseintegrationpatterns.com/MessageSelector.html[Selective Consumer].
