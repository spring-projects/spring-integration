...
The `SerializingHttpMessageConverter` now has a constructor that requires the patterns of classes allowed for deserialization.
Its default constructor and `setAllowedPatterns()` method are deprecated.
