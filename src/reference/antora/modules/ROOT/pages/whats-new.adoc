...
- The default trigger for polling endpoint is now a `PeriodicTrigger` instance of 1-second fixed delay period instead of very tight 10 milliseconds before.
See xref:endpoint.adoc#endpoint-pollingconsumer[Polling Consumer] for more information.
