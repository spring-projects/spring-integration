...
More can read about asynchronous service activators https://docs.spring.io/spring-integration/reference/service-activator.html#async-service-activator[here].
