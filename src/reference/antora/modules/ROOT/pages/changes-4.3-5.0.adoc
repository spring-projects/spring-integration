...
See xref:jdbc/metadata-store.adoc[JDBC Metadata Store] for more information.
...
See `xref:leadership-event-handling.adoc[Leadership Event Handling]` for more information.
