...
Because it runs embedded within the application classpath, Spring Integration is an ideal fit for both traditional on-premises deployments and cloud-native architectures.
...
As discussed in xref:overview.adoc#programming-considerations[Programming Considerations], we recommend using a POJO programming style, as the following example shows:
