...
See https://docs.micrometer.io/micrometer/reference/concepts/meter-filters.html[Meter Filters] in the Micrometer documentation for more information.
...
Starting with version 6.0, Spring Integration utilizes a Micrometer Observation abstraction which can handle metrics as well as https://docs.micrometer.io/tracing/reference/[tracing] via appropriate `ObservationHandler` configuration.
