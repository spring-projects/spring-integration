...
When encountering a requirement to filter incoming messages, (for example, a requirement to read emails only that have 'Spring Integration' in the `Subject` line).
