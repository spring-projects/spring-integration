...
For more details see the guidelines at the https://github.com/spring-projects/spring-integration/blob/main/CONTRIBUTING.md[CONTRIBUTING], top-level project page.
