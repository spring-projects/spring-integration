...
When configuring with Java, different constructors are available in the https://docs.spring.io/spring-integration/api/org/springframework/integration/ftp/outbound/FtpOutboundGateway.html[`FtpOutboundGateway`] class.
