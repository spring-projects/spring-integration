...
Also, many Spring Integration channel adapters and patterns are implemented as function autoconfiguration in the https://github.com/spring-cloud/spring-functions-catalog[Spring Functions Catalog] project.