...
public class RedisOutboundGateway extends AbstractReplyProducingMessageHandler
	...
	/**
	 * @deprecated in favor of {@link #setExpressionCommand}. Will be changed in the future release
	...
	/**
	 * Temporary, will be changed to the {@link #setCommandExpression} in the future release.
	 * @param commandExpression the expression to set.
	 */
