 ...
 *
 */
public final class ZeromqParserUtils {

	/** Prevent instantiation. */
	private ZeromqParserUtils() {
	...
	public static void parseCommon(Element element, BeanDefinitionBuilder builder, ParserContext parserContext) {
		...
		if (StringUtils.hasText(clientFactory)) {
			...
			builder.addConstructorArgValue(new RootBeanDefinition(org.springframework.integration.zeromq.core.DefaultZeromqClientFactory.class));
		}
